                                                ...
                                                ModuleAnalysisManager &AM)
{
    ...
    for (Function &f : M)
    {
        if (llvm::toObfuscate(flag, &f, "enfla"))
        {  // 显式调用 llvm::toObfuscate
            ...
            [](PassBuilder &PB)
            {
                PB.registerPipelineParsingCallback(
                           ...
                           ArrayRef<PassBuilder::PipelineElement>)
                        {
                            ...
                            {
                                MPM.addPass(
                                        llvm::FlatteningEnhanced(true));  // Use namespaced class
                                return true;
                            }
                            return false;
                        });
                // Example of registering for a specific optimization pipeline point
