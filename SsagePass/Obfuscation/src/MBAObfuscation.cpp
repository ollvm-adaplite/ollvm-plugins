...
MBAObfuscation llvm::createMBAwithoutprt(bool flag) {
    return  MBAObfuscation(flag);
}

PreservedAnalyses MBAObfuscation::runOnModule(Module &M, ModuleAnalysisManager &AM) {
    for (Function &F : M) {
