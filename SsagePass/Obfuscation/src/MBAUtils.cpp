...
Value *llvm::insertLinearMBA(int64_t *params, Instruction *insertBefore) {
    ...
    Value *mbaExprAlloca = builder.CreateAlloca(mbaVarType, nullptr, "mbaExprAlloca");
    builder.CreateStore(ConstantInt::get(mbaVarType, 0), mbaExprAlloca);
    // Use getAllocatedType() for AllocaInst
