...
Function *IPObfuscationContext::InsertSecretArgument(Function *F) {
  ...
  PointerType *I32PtrTy =
      PointerType::get(F->getContext(), 0); // i32* maybe: PointerType::get(Type::getInt32Ty(F->getContext()), /*AS=*/0);?
  Params.push_back(I32PtrTy);
...
IPObfuscationContext::AllocaSecretSlot(Function &F) {
  ...
  LoadInst *MySecret =
    IRB.CreateLoad(I32Ty, CallerSlot, "MySecret");
